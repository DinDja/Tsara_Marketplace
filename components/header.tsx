...
function MoonIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path d="M22.1602 13.9363C20.6605 14.5378 18.795 14.7112 17.212 14.3871C15.629 14.0629 14.1761 13.281 13.0336 12.1384C11.891 10.9959 11.1091 9.54296 10.7849 7.95999C10.4608 6.37703 10.6086 4.73371 11.21 3.234C11.2456 3.10265 11.2448 2.96409 11.2076 2.83317C11.1705 2.70225 11.0984 2.5839 10.9992 2.4908C10.8999 2.39771 10.7772 2.33337 10.6442 2.30469C10.5111 2.27601 10.3728 2.28407 10.244 2.328C6.073 3.428 3 7.23 3 11.75C3 17.135 7.365 21.5 12.75 21.5C14.8434 21.488 16.8769 20.8004 18.5479 19.5395C20.2189 18.2785 21.4381 16.5117 22.024 14.502L22.1602 13.9363Z" fill="black" />
      <path opacity="0.6" d="M18 6C18.5523 6 19 5.55228 19 5C19 4.44772 18.5523 4 18 4C17.4477 4 17 4.44772 17 5C17 5.55228 17.4477 6 18 6Z" fill="black" />
      <path opacity="0.4" d="M20 8.5C20.2761 8.5 20.5 8.27614 20.5 8C20.5 7.72386 20.2761 7.5 20 7.5C19.7239 7.5 19.5 7.72386 19.5 8C19.5 8.27614 19.7239 8.5 20 8.5Z" fill="black" />
      <path opacity="0.5" d="M15 3.5C15.2761 3.5 15.5 3.27614 15.5 3C15.5 2.72386 15.2761 2.5 15 2.5C14.7239 2.5 14.5 2.72386 14.5 3C14.5 3.27614 14.7239 3.5 15 3.5Z" fill="black" />
    </svg>
  )
}
